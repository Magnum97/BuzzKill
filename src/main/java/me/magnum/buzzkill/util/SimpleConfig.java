package me.magnum.buzzkill.util;
...
public class SimpleConfig  extends YamlConfiguration  {
	...
	private me.magnum.buzzkill.util.SimpleConfigManager manager;
	...
	public SimpleConfig (InputStreamReader configStream, File configFile, int comments, boolean useDefaults, JavaPlugin plugin) {
		...
		this.manager = new me.magnum.buzzkill.util.SimpleConfigManager(plugin);
	...
	public Object get(String path, Object def) {
		if (defaults != null) {
			...
			if (super.get(path, null) == null) {
				...
				log.info("&fUpdating &a" + file.getName() + "&f. Set '&b" + path + "&f' to '" + defaultValue + "'");
